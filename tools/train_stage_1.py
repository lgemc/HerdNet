...
work_dir = '/workspace/HerdNet/data' # output directory
os.makedirs(work_dir, exist_ok=True)
root_dir = '/workspace/HerdNet/data/train_patches' # generated by tools/patcher.py
...
val_dataset = CSVDataset(
    csv_file = '/workspace/HerdNet/data/val_patches/gt.csv',
    root_dir = '/workspace/HerdNet/data/val_patches',
